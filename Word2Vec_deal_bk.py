...
def build_dataset(character_list):
    count = [['UNK', -1]]
...
data, count, dictionary, reverse_dictionary = build_dataset(character_list)
...
with tf.Session(graph=graph) as session:
    ...
    summary_writer = tf.summary.FileWriter(
        '/home/wuchao/paper/sentiment_analysis/word2vec/logdir', session.graph)
